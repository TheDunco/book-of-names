	...
	<div class="flex flex-col mt-4 gap-2">
		...
		{#if detail}
			<Modal>
				...
				<div slot="content">
					<span class="text-c-caption-gray text-2xl">Detailed Stats</span>
					<div class="border-l-2 mt-5 pl-5 border-c-gold">
						<span
							class="grid w-full grid-cols-2 justify-between gap-4 xs:flex xs:flex-row md:gap-6"
						>
							<LabelValue label="Health">
								<div class="inline-flex flex-wrap">
									<span class="text-c-gold">
